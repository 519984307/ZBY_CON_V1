...
QT_MOC_LITERAL(1, 4, 17), // "signal_newLogText"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "QtMsgType"
QT_MOC_LITERAL(4, 33, 4), // "type"
QT_MOC_LITERAL(5, 38, 4), // "time"
QT_MOC_LITERAL(6, 43, 5), // "value"
QT_MOC_LITERAL(7, 49, 11) // "slot_addLog"

    },
    "Log\0signal_newLogText\0\0QtMsgType\0type\0"
    "time\0value\0slot_addLog"
};
...
void Log::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slot_addLog((*reinterpret_cast< QtMsgType(*)>(_a[1])),(*reinterpret_cast< QDateTime(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Log::*)(QtMsgType , QDateTime , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Log::signal_newLogText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Log::signal_newLogText(QtMsgType _t1, QDateTime _t2, QString _t3)
{
